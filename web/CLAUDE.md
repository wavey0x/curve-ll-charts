...
### API Integration
All Wavey API requests use the shared client in `src/api/client.js`.
Production defaults to `https://api.wavey.info`; local development can set
...
- **API Data**: Component-level state using the shared API client
